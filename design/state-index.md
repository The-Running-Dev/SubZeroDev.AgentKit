...
| decision/2026-09-03-track-retires-a-landed-slice-via-a-script | `unit/command/track`, `unit/script/update-slicesdocument` |
| decision/2026-09-05-brief-ceiling-excludes-the-retired-companion | `unit/document/design-00-brief` |
| decision/2026-09-05-failure-modes-gets-the-missing-rows | `unit/document/design-10-design` |
...
| decision/2026-09-05-public-surface-check-asserts-correspondence-not-count | `unit/script/test-designstate` |
...
| decision/2026-09-18-a-finding-cites-its-evidence-or-it-is-demoted | `unit/document/agents-md` |
| decision/2026-09-18-force-push-and-history-rewrite-are-no-longer-prohibited-outright | `unit/document/agents-md` |
