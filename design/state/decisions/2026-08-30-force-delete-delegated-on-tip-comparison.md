...
Status: accepted
StatedIn: unit/document/agents-md § Git and delivery, contract/invoke-donehousekeeping § Semantics, unit/command/clean § Force-delete a squash-merged candidate — don't ask either
