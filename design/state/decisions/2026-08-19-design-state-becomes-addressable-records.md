...
Status: accepted
StatedIn: unit/document/design-10-design § Data model, unit/document/design-10-design § Every restatement is either forbidden or checked, unit/document/design-10-design § The orientation closure, unit/document/design-10-design § Module boundaries, unit/document/design-10-design § Failure modes
