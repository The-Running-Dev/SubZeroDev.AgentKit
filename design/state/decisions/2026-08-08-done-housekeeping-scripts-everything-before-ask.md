...
Status: accepted
StatedIn: contract/invoke-donehousekeeping § Semantics, unit/command/clean § Run the mechanical half, unit/command/clean § Delete the confirmed candidates — don't block on a prompt
