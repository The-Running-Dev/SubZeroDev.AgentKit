...
Status: accepted
StatedIn: unit/command/clean § Hand off to `/next` — always, "unit/command/track § Commit the refresh to the default branch — no branch, no pull request", unit/document/agents-md § Git and delivery
