...
BeforeAll {
    ...
    # stub is what Mock replaces instead of the real executable, so S7.10 exercises only the
    # mocked behavior on every platform regardless of whether `gh` is installed.
    function gh {}
