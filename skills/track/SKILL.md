...
**Per-repo companion:** `skills/track/SKILL-local.md`. Read it now, if it exists — an absent,
...
Stop conditions and procedure: `skills/slice/SKILL.md`. Not restated here.
<!-- agent:end -->
</details>
```
